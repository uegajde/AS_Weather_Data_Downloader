    ...
    Private Sub Download()
        ...
        If Me.Enable(D) = True Then
            ...
            For i = 0 To Me.Period(D)
                ...
                If (Hour Mod 6) = 0 Then DownloadFile("http://www.cwb.gov.tw/V7/forecast/nwp/Data/GFS/GFS_" + TimeForName.Substring(2, 8) + "_DS2-GE_000.gif", Application.StartupPath + "\流線圖", "GFS_" + TimeForName.Substring(2, 8) + "_DS2-GE_000.gif")
            Next
            Me.DS(D) = 2
            Call PreRefreshState()
        End If
